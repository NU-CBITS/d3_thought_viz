var thoughts =  [
    ...
    var patternFrequencies = [parseInt(allOrNothing), parseInt(overgeneralization), parseInt(mentalFilter),
                                parseInt(disqualifying), parseInt(jumpingToConclusions), parseInt(magnification),
                                parseInt(minimization), parseInt(emotionalReasoning), parseInt(shouldStatements),
                                parseInt(labelingMislabeling), parseInt(personalization)];
                               
    // color of dot, index matches patternNames
    var color = d3.scale.ordinal()
        .range(["#98abc5", "#8a89a6", "#7b6888", "#339966", "#996699", "#CC6666", "#9999FF", "#FFCC99", "#FFCCFF", "#6666FF", "#FF66000"]);
    ...
    var patternNames = d3.scale.ordinal()
        .range(['All-Or-Nothing Thinking', 'Overgeneralization', 'Mental Filter', 'Disqualifying the positive', 
                    'Jumping to conclusions', 'Magnification', 'Minimization', 'Emotional Reasoning',
    ...
    var recommendations = ['See shades of grey', 'Focus on specifics', 'See the big picture', 
                            'Consider all options', 'Gather all the facts', 'Put it in context',
                            'Its important', 'Is that your head or heart?', 'Shoulda coulda woulda', 
